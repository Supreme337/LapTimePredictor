...
class ModelTrainer:
    ...
    def log_mlflow(self,model,train_metrics,test_metrics):
        with mlflow.start_run(run_name="XGBoost_Trainer"):
            ...
            mlflow.log_metric("train_rmse",train_metrics.root_mean_squared_error)
            ...
            mlflow.log_metric("test_rmse",test_metrics.root_mean_squared_error)
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            x_train=np.load(self.data_transformation_artifact.transformed_train_file_path,allow_pickle=True)
            x_test=np.load(self.data_transformation_artifact.transformed_test_file_path,allow_pickle=True)
            y_test=np.load(self.data_transformation_artifact.y_test_file_path,allow_pickle=True)
            y_train=np.load(self.data_transformation_artifact.y_train_file_path,allow_pickle=True)
