...
from laptime.components import(
    ...
    DataTransformation,
    ModelTrainer)
from laptime.entity.config_entity import(
...
from laptime.entity.artifact_entity import(
    DataIngestionArtifact,
    DataValidationArtifact,
    DataTransformationArtifact,
    ModelTrainerArtifact
)
from laptime.constant.constants import SAVED_MODEL_DIR,TRAINING_BUCKET_NAME
