...
COLUMNS_TO_DROP=['lap','milliseconds','driverId_y','year','round','name_y','name_x','constructorId','LapTime','location','alt'
...
DATA_TRANSFORMATION_Y_TRAIN_FILE_PATH:str="y_train.npy"
DATA_TRANSFORMATION_Y_TEST_FILE_PATH:str="y_test.npy"
